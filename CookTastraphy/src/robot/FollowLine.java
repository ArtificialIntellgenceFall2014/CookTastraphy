...
public class FollowLine 
{
    ...
    public static void main (String[] aArg) throws Exception 
    {
    	...
    	final Pilot pilot = new Pilot(2.3f,1.5f,Motor.A, Motor.C);
    	...
    	Behavior Intersection = new Behavior() 
    	{
    		...
    		public void action() 
    		{
    			...
    			screen.clearDisplay();
    			screen.drawString("C: " + light.readValue(), 0, 0);
	    ...
	    Behavior FindLine = new Behavior() 
	    {
	    	...
	    	public void action() 
	    	{
	    		...
	    		if(light3.readValue() <= THRESHOLD) 
	    		{
	    			sweep = -Math.abs(sweep); 
	    			initTrue = true;
	    		}
	    		if(light2.readValue() <= THRESHOLD) 
	    		{
	    			initTrue = true;
	    		}
